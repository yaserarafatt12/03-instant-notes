  ...
  return (
    <div
      ...
      className={`group relative p-4 rounded-2xl transition-all cursor-pointer select-none font-sans flex flex-col justify-between h-64 border ${
        isSelected
          ? 'bg-[#282830] border-indigo-500/70 shadow-xl ring-1 ring-indigo-500/30'
          : 'bg-[#222227] border-white/10 hover:bg-[#28282e] hover:border-white/20 shadow-md shadow-black/40 hover:shadow-2xl'
      }`}
    >
      ...
      {/* Middle Dark-Theme Document Paper Preview (Sleek Dark Slate Container) */}
      <div className="flex-1 my-3 bg-[#18181c] rounded-xl p-3 border border-white/5 overflow-hidden text-left shadow-inner">
        <p className="text-[11px] text-zinc-300 font-normal leading-relaxed line-clamp-5 select-none opacity-90">
